...
RXM_CLS = core.Cls(0x02, 'RXM', [
    core.Message(0x15, 'RAWX', [
        ...
        core.RepeatedBlock('RB', [
            ...
            core.Field('reserved1', 'U1')
            ])
        ]),
    core.Message(0x32, 'RTCM', [
        core.Field('version', 'U1'),
        core.BitField('flags', 'X1', [
            core.Flag('crcFailed', 0, 1),
            core.Flag('msgUsed', 1, 3)
            ]),
        core.Field('subType', 'U2'),
        core.Field('refStation', 'U2'),
        core.Field('msgType', 'U2')
        ])
    ])
